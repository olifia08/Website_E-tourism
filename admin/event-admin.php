...
<div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div id="eventAdmin" class="pt-3">
          <h2>Event Admin</h2>
          <a href="tambah-event.php" class="btn btn-primary mb-3">Tambah Event</a>
          <table class="table table-bordered">
            ...
            <?php
                ...
                echo "<td>" . $row['WAKTU_EVENT'] . "</td>";
                echo "<td>" . $row['gambar_event'] . "</td>";
                echo "<td>" . $row['LINK_EVENT'] . "</td>";
                echo '<td>';
                echo '<a href="update-event.php?id=' . $row['ID_EVENT'] . '" class="btn btn-info">Edit</a>';
                echo '<form method="post" action="hapus-event.php">';
