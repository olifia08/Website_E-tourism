    ...
    <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div id="newsAdmin" class="pt-3">
          <h2>News Admin</h2>
          <a href="tambah-news.php" class="btn btn-primary mb-3">Tambah Berita</a>
          <table class="table table-bordered">
            ...
            <tbody>
              <?php
                ...
                echo "<td>" . $row['tanggal_berita'] . "</td>";
                echo "<td>" . $row['PENULIS_BERITA'] . "</td>";
                echo "<td>" . $row['gambar_berita'] . "</td>";
                echo "<td>" . $row['LINK_BERITA'] . "</td>";
                echo '<td>';
                echo '<a href="update-news.php?id=' . $row['ID_BERITA'] . '" class="btn btn-info">Edit</a>';
                echo '<form method="post" action="hapus-news.php">';
                echo '<input type="hidden" name="id" value="' . $row['ID_BERITA'] . '">';
