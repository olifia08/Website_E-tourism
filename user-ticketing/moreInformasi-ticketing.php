...
// Pastikan sesi telah dimulai dan $_SESSION['USERNAME_USER'] telah diatur
$username = isset($_SESSION['USERNAME_USER']) ? $_SESSION['USERNAME_USER'] : 'Guest';
          ...
          if ($result->num_rows > 0) {
              ...
              echo '<th class="syarat">Syarat & Ketentuan</th>';
...
<section class="ftco-section contact-section ftco-degree-bg">
  ...
  <div class="faq-section">
    <ul>
    <li class="item">Menjaga Kebersihan Tempat Wisata</li>
    <br>
    <li class="item">Mengikuti Himbauan Dan Petunjuk Petugas Wisata</li>
    <br>
    <li class="item">Tiket Yang Sudah Dibayar Tidak Dapat Dikembalikan (No-Refundable)</li>
  </ul>
  </div>
  ...
  <div class="tubuh">
    <div class="container">
      ...
      <div class="faq-section">
        <div class="faq-item">
          <h6 class="faq-question">Bagaimana cara menuju ke lokasi wisata X?</h6>
          <div class="faq-answer">
            <p>Anda dapat menuju ke lokasi wisata X dengan menggunakan kendaraan pribadi atau transportasi umum. Rute terbaik adalah melalui jalan Y, yang akan membawa Anda langsung ke tempat tersebut.</p>
          </div>
        </div>
        <div class="faq-item">
          <h6 class="faq-question">Apa saja jam operasional tempat wisata Y?</h6>
          <div class="faq-answer">
            <p>Tempat wisata Y buka setiap hari dari pukul 08:00 hingga 17:00. Namun, jam operasional dapat berubah selama hari libur nasional.</p>
          </div>
        </div>
        <div class="faq-item">
          <h6 class="faq-question">Apakah ada biaya masuk ke tempat wisata Z?</h6>
          <div class="faq-answer">
            <p>Ya, ada biaya masuk ke tempat wisata Z. Untuk dewasa, biayanya adalah Rp50.000 dan untuk anak-anak Rp30.000. Tiket bisa dibeli langsung di lokasi atau secara online.</p>
          </div>
        </div>
        <div class="faq-item">
          <h6 class="faq-question">Apakah di sekitar tempat wisata tersedia penginapan?</h6>
          <div class="faq-answer">
            <p>Ya, di sekitar tempat wisata terdapat berbagai pilihan penginapan mulai dari hotel berbintang hingga guest house yang lebih terjangkau. Disarankan untuk memesan penginapan jauh-jauh hari terutama saat musim liburan.</p>
          </div>
        </div>
      </div>
