    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="news-ticketing.php" class="nav-link active">News</a></li>
          <li class="nav-item"><a href="event-ticketing.php" class="nav-link">Event</a></li>
          ...
          <div class="col-md-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li><a href="event-ticketing.php">Event <span>(3)</span></a></li>
                <li><a href="beranda-user-ticketing.php">Fasilitas<span>(6)</span></a></li>
              </div>
            </div>
